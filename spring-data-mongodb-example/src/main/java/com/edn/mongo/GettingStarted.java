...
import com.edn.mongo.repository.ContinentRepository;
...
public class GettingStarted {
	...
	public static void main(String[] args) {
		...
		Continent[] continents = new Continent[] { new Continent(1, "Africa"), new Continent(2, "Asia"),
				new Continent(3, "Europe"), new Continent(4, "North America"), new Continent(5, "South America"),
